<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About2.aspx.cs" Inherits="B_G_Patel_Tea_Shop.About2" %>
...
<form runat="server">
    ...
    <div class="header">
        ...
        <div class="menu">
            <asp:ImageButton ID="btnHome" runat="server" ImageUrl="Images/Home.png" Width="28px" Height="28px" PostBackUrl="~/UserHome.aspx" />
            <asp:ImageButton ID="btnCart" runat="server" ImageUrl="Images/cart.png" Width="28px" Height="28px" PostBackUrl="Cart.aspx" />
        </div>
    </div>
